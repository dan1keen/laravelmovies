...
@section('content')
    <div class="container" >
        ...
        <div class="row mt-4">
            ...
            @foreach($resultData->cast as $single)

                <div class="card card-custom mx-3 mb-4">
                    <a href="">
                        @if($single->profile_path)
                        <img src="https://image.tmdb.org/t/p/w138_and_h175_face{{$single->profile_path}}"
                             style="width: 138px; height: 175px;" class="card-img">
                        <br>
                        <center>{{ str_limit($single->name, $limit = 15, $end = '...') }}
                        <br>
                            {{str_limit($single->character, $limit = 15, $end = '...')}}
                        </center>
                            @else
